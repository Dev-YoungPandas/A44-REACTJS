  ...
  return (
    ...
    >
      <div className="md:w-[30%] w-full  flex items-center justify-center">
        <h5 className="md:text-[1.8vw] text-[8vw] text-center xl:text-start  font-bold leading-[7vw] md:leading-[2.2vw] w-full md:w-[10vw] tracking-[-0.03em]">
          Hype tattoo in number
        </h5>
      </div>
      <div className="md:w-[70%] w-full flex items-center justify-center">
        <ul className="grid grid-cols-1 md:grid-cols-4 gap-[5vw]">
          <li>
            ...
            <p className=" text-[4vw] md:text-[1vw] font-medium leading-[1vw]  text-center xl:text-left text-[#B3B3B3]">
              professional craftsmen
            </p>
          </li>
          <li>
            <span className="block text-[25vw] md:text-[5.2vw] font-semibold mb-[2vw] text-center xl:text-left">
